  ...
  return (
    <div>
      ...
      <div className={`proff-container ${activeProff === 'second' ? 'active' : ''}`} id="second-proff">
        ...
        <div className="subjects-grid">
          {['Dravyaguna Vigyan','Rasa Shastra & Bhaishajya Kalpana','Rog Nidan & Vikriti Vigyan','Charak Samhita (Uttarardha)','Swasthavritta & Yoga','Sanskrit'].map((name) => (
